...
final class Config implements ConfigContract
{
    ...
    public static function getDefaultConfig(): ConfigContract
    {
        ...
        $themeTextShadow = ThemeGetter::fromTheme('text-shadow');
        ...
        $isNonArbitrary = resolve(Validators\IsAnyNonArbitrary::class);
        ...
        $scaleBreak = static fn () => ['auto', 'avoid', 'all', 'avoid-page', 'page', 'left', 'right', 'column'];
